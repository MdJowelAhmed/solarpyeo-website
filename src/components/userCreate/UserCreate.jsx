        ...
        <div className="bg-white border  shadow-md rounded-lg p-6 md:p-8 w-full max-w-lg mx-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2">
              <div>
                <label htmlFor="firstName" className="block text-sm mb-2 text-black">
                  First Name*
                </label>
                <Input
                  id="firstName"
              ...
              <div>
                <label htmlFor="middleName" className="block text-sm mb-2 text-black">
                  Middle Name
                </label>
                <Input
                  id="middleName"
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm mb-2 text-black">
                  Last Name*
                </label>
                <Input
                  id="lastName"
              ...
              <div className="md:col-span-1">
                <label htmlFor="address" className="block text-sm mb-2 text-black">
                  Address
                </label>
                <Input
                  id="address"
