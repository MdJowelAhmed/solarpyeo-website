                ...
                <div className="w-1/2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h1 className="text-2xl">
                          Request to Seal or Expunge a Record
                        </h1>
                        <h4 className="">
                          For reporting abuse, falsified submissions,
                          retaliation, unethical activity, or other violations
                  ...
                  <div className="mb-6">
                    <CardContent className="pt-6">
                      <div className="mb-4">
                        <h2 className="font-medium">Platform Account Email</h2>
                      </div>
                      <div>
                ...
                <div className="mb-6 w-1/2">
                  <CardHeader className="mb-5">
                    ...
                    <p className="font-semibold">
                      Submission ID: [Auto-populated]
                    </p>
                    <p className="font-semibold">
                      Submission Date: [Auto-populated]
                    </p>
                  </CardHeader>
                  <h2 className="font-medium text-xl mb-6 ml-4">
                    Requesting Party:
                  </h2>
              ...
              <div className="container mx-auto">
                ...
                <CardContent className="space-y-3">
                  {[
                    <>Allegation Record</>,
                    <>
                      Verified Proven <span className="font-bold">VP</span>{" "}
                      Record
                    </>,
                    <>
                    ...
                    <>
                      Duly Disproven <span className="font-bold">DD</span>{" "}
                      Record
                    </>,
                    <>
                  ...
                  <div className="mt-4">
                    <h4 className="mb-6">
                      ...
                      sealing or expungement only under verified circumstances
                      such as mistaken assignment, account error, or breach of
              ...
              <div className="container mx-auto">
                <CardHeader>
                  ...
                  <h4 className="mb-6 text-center">
                    Please describe the event(s), behavior(s), and any
                    associated case(s). Include dates, communication, or
                    submissions if known.
                  </h4>
                </CardHeader>
                <CardContent className="space-y-6">
                  {/* Checkbox List */}
              ...
              <div className="container mx-auto">
                <CardHeader>
                  ...
                  <h4 className="mb-6 max-w-4xl mx-auto">
                    ...
                    should be sealed or expunged. Be specific. If this relates
                    to juror conduct, describe the case interaction, what
                    occurred, and what remedy you are seeking.
                  </h4>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                ...
                <CardContent className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="signature-day">📍 IP Address: [Auto-captured]</Label>
                    </div>
                  </div>
                  ...
                  <div className="bg-primary-foreground border-l-4 border-red-700 rounded-lg p-4">
                    ...
                    <p className="text-sm ">
                      KNOWINGLY MAKING A MATERIALLY FALSE STATEMENT ON THIS FORM
                      IS A 4TH DEGREE CRIME. N.J.S.A. 2C:28-2 makes knowingly
                      making a materially false statement in any government
                      document a crime punishable by up to 18 months in prison
                      and a fine of up to $10,000, or both. Answering this
